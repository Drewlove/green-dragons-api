...
const serializeRow = row => ({
  ...
  subcommunity_name: xss(row.subcommunity_name),
})
...
endpointRouter
  ...
  .post(jsonParser, (req, res, next) => {
    const {subcommunity_name, community_id} = req.body
    const newRow = {subcommunity_name, community_id}
...
endpointRouter
  ...
  .patch(jsonParser, (req, res, next) => {
    ...
    const {subcommunity_name, community_id} = req.body
    const rowToUpdate = {subcommunity_name, community_id }
