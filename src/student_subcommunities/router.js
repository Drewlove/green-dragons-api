...
const serializeRow = (row) => ({
  student_subcommunity_id: row.student_subcommunity_id,
...
endpointRouter
  ...
  .post(jsonParser, (req, res, next) => {
    const { student_id, subcommunity_id } = req.body;
    const newRow = { student_id, subcommunity_id };
...
endpointRouter
  ...
  .patch(jsonParser, (req, res, next) => {
    ...
    const { student_subcommunity_id, student_id, subcommunity_id } = req.body;
    const rowToUpdate = {
      student_subcommunity_id,
      student_id,
      subcommunity_id,
    };
